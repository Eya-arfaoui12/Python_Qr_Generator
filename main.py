...
root.resizable(False,False) #making the window a fixed size

#icon image
image_icon = PhotoImage(file="qr-code.png")
...
root.mainloop() #This function keeps the application running and responsive.